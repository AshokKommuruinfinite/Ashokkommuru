...

{
...

    {
...

        {
            ...
            decimal usage = BillingSystem.CalculateUsage(readings);

            total = usage * ratePerUnit;

            tax = BillingSystem.CalculateTax(total);

            netPayable = total + tax + BillingSystem.serviceCharge;
...

        {
            ...
            Console.WriteLine($"Service Charge    : ₹{BillingSystem.serviceCharge:F2}");
